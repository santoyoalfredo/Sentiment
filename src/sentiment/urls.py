...
urlpatterns = [
    ...
    url(r'^adminproduct/$', views.adminProduct, name='admin_product'),
    url(r'^adminreview/$', views.adminReview, name='admin_review'),
    ...
    url(r'^unflag_review/$', views.unflag_review, name='unflag_review'),
